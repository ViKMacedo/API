...
namespace MyApiWithDoc.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        private static IEnumerable<ClientResponse> NoFilter()
        {
        ...
        private static ClientResponse FilterById(int id)
        {
            return (from client in mockClients.Data
        ...
        private static IEnumerable<ClientResponse> FilterByName(string name)
        {
            return from client in mockClients.Data
        ...
        private static IEnumerable<ClientResponse> FilterByGender(Gender? gender)
        {
            return from client in mockClients.Data
        ...
        private static object FilterByNameAndGender(string name, Gender? gender)
        {
            return from client in mockClients.Data
